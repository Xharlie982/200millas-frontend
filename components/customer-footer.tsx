        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-4">
          ...
          <div className="flex flex-col items-center md:items-end md:pl-8">
            ...
            <div className="flex space-x-4 mb-6">
              <a href="#" className="text-white hover:text-[#e2e200] transition cursor-pointer" style={{ width: '44px', height: '44px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
